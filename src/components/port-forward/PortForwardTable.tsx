          ...
          {isLoading ? (
            ...
            <TableRow>
              <TableCell colSpan={12} className="py-16 text-center">
                {!hasVessel ? (
                  <StatusPlaceholder title="Failed to load rules" description="Please select a vessel" />
                ) : fetchError ? (
                  <StatusPlaceholder title="Failed to load rules" description={fetchError} onRetry={onRetry} />
                ) : (
