...
export default memo(function DistancePanel({
  ...
  const distanceKm = vLat !== null && displayVLng !== null
    ? haversineKm(vLat, displayVLng, target.lat, target.lng)
    : null;

  const etaHours = distanceKm !== null && speed !== null && speed > 0
    ? distanceKm / (speed * 1.852)
    : null;
