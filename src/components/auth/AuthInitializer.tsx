    ...
    return (
      <div className="fixed inset-0 z-[9999] flex items-center justify-center bg-white dark:bg-gray-900">
        <div className="flex flex-col items-center gap-6 text-center">
          ...
          <a
            href="https://synersatfleet.net/web/login?redirect_uri=https://synersatfleet.net/web/launch/dashboard.synersatfleet.net%3Fpath%3D%252F%26query%3D_rsc%253D1x43y"
