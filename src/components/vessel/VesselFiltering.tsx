    ...
    <div ref={rootRef} className={`relative w-full max-w-[320px] ${className}`}>
      <div className="relative">
        <input
          ...
          className="h-10 w-full rounded-xl border-2 border-gray-300 bg-white pr-10 pl-10 text-sm shadow-sm outline-none transition-all placeholder:text-gray-400 focus:border-blue-500 focus:ring-2 focus:ring-blue-500/20 dark:border-gray-600 dark:bg-gray-800 dark:text-white dark:placeholder:text-gray-500 dark:focus:border-blue-400"
        />
